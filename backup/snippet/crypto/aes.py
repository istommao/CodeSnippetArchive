"""
All code from https://github.com/ytdl-org/youtube-dl
"""
import sys
import base64
...
def aes_decrypt_text(data, password, key_size_bytes):
    ...
    key = aes_encrypt(key[:BLOCK_SIZE_BYTES], key_expansion(
        key)) * (key_size_bytes // BLOCK_SIZE_BYTES)
...
def main():
    ...
    secret_msg = 'aes in CBC mode, using PKCS#7 padding'
    data = bytes_to_intlist(secret_msg)
